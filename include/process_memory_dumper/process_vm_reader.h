...
namespace process_memory_dump
{
    ...
    public:
        /**
         * @brief Создает объект чтения памяти процесса через системный вызов process_vm_readv.
         */
        ProcessVmReader();
        ...
        /**
         * @brief Проверяет, доступно ли чтение памяти указанного процесса данным методом.
         *
